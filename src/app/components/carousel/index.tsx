...
const LogoCarousel = () => {
  ...
  return (
    <section
      id="2"
      className="bg-secondary w-full inline-flex flex-nowrap overflow-x-hidden pb-8 pt-4 lg:h-64 [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-100px),transparent_100%)]"
    >
